    ...
    <div className="p-6 space-y-6 ml-64">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">Manage passwords, two-factor authentication, and security settings</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">Company settings, integrations, and data management</p>
          </CardContent>
        </Card>
      </div>
    </div>
